...
function isMainFramePart() {
    ...
    if(elements.length > 0 || filename.endsWith("https://docs.oracle.com/en/dcommon/js/-frame.html")) {
        return false;
    } else {
        return true;
    }
...
function addSiteCatalyst() {
  ...
  oraScript.src = "ora_docs.js"/*tpa=https://www.oracleimg.com/us/assets/metrics/ora_docs.js*/;
